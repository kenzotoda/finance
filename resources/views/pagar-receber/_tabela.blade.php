                    ...
                    <tr class="conta-row align-middle" data-conta-id="{{ $conta->id }}">
                        <td class="px-5 py-4">
                            <div class="inline-flex max-w-full items-center gap-2">
                                ...
                                @if ($conta->descricao)
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#descricaoContaModal" data-conta-titulo="{{ $conta->titulo }}" data-conta-descricao="{{ $conta->descricao }}" class="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full border border-gray-300 bg-gray-50 p-0 text-gray-600 transition hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-1" aria-label="Abrir descricao">
                        ...
                        <td class="px-5 py-4 text-right">
                            <div class="inline-flex flex-wrap items-center justify-end gap-2">
                                <a href="{{ route('pagar-receber.edit', $conta) }}" class="inline-flex h-8 min-w-[4.25rem] items-center justify-center rounded-md border border-gray-300 bg-white px-3 text-xs font-medium text-gray-700 shadow-sm transition hover:border-gray-400 hover:bg-gray-50">
                                    Editar
                                </a>
                                <button
                                    type="button"

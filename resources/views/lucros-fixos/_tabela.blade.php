                    ...
                    <tr class="align-middle">
                        ...
                        <td class="px-5 py-4 text-right">
                            <div class="inline-flex items-center justify-end gap-2">
                                <a href="{{ route('lucros-fixos.edit', $lucroFixo) }}" class="inline-flex h-8 min-w-[4.25rem] items-center justify-center rounded-md border border-gray-300 bg-white px-3 text-xs font-medium text-gray-700 shadow-sm transition hover:border-gray-400 hover:bg-gray-50">
                                    Editar
                                </a>

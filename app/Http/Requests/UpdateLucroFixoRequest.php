...
class UpdateLucroFixoRequest extends FormRequest
{
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            'dia_vencimento' => $periodicidade === LucroFixo::PERIODICIDADE_ANUAL ? 1 : $diaVencimento,
            'renovacao_mes' => $periodicidade === LucroFixo::PERIODICIDADE_ANUAL ? $renovacaoMes : null,
            'renovacao_ano' => $periodicidade === LucroFixo::PERIODICIDADE_ANUAL ? $renovacaoAno : null,
        ]);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'periodicidade' => ['required', Rule::in([LucroFixo::PERIODICIDADE_MENSAL, LucroFixo::PERIODICIDADE_ANUAL])],
